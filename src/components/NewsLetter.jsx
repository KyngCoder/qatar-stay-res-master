...
export default function NewsLetter() {
    ...
    return (
        ...
        <div className="NewsLetter p-4 md:p-12 bg-slate-800">
            
            <div 
                className=" w-full md:w-3/5 mx-auto text-center p-4 md:p-12 bg-purple-100  rounded-2xl shadow-3xl drop-shadow-xl"
            >
                <h2 className="text-2xl md:text-3xl font-semibold">Get The Latest <span className="text-blue-500">Hotel Book</span> Update</h2>
